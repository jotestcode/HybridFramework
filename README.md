...
A Hybrid Automation Framework built using Python, Pytest, Selenium WebDriver, and Requests. This framework combines UI Automation and API Automation into a single project, following the Page Object Model (POM) design pattern for UI tests and a reusable API client for REST API testing.
